...
<script src="http://<?php echo($host) ?>/plugins/fancybox/jquery.fancybox.min.js"></script>
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,900" rel="stylesheet"/>
...
<link rel="stylesheet" href="http://<?php echo($host) ?>/plugins/fancybox/jquery.fancybox.min.css"/>
...
<script src="http://<?php echo($host) ?>/plugins/videojs/video.min.js"></script>
<link href="http://<?php echo($host) ?>/plugins/videojs/video-js.min.css" rel="stylesheet">
...
<!--<meta name="keywords" content="html,css,javascript,php,mysql,jquery,base de dados, fotografia,portfolio, website, web design, web development, programação, desenho web, programação web, script, branding, logo design">-->
